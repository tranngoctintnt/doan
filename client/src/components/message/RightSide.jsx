    ...
    <>
      <div className="message_header" style={{ cursor: 'pointer' }}>
        {user.length !== 0 && (
          <UserCard user={user}>
            <div>
              <i className="fas fa-phone-alt text-info" onClick={handleAudioCall} />

              <i className="fas fa-video mx-3 text-info" onClick={handleVideoCall} />
      ...
      >
        <div className="chat_display" ref={refDisplay}>
          ...
          {loadMedia && (
            <div className="chat_row you_message">
              <img src={LoadIcon} alt="loading" style={{ width: '88px' }} />
            </div>
          )}
        </div>
      </div>
      ...
      <form className="chat_input w-100" onSubmit={handleSubmit}>
        <input
          type="text"
        ...
        <div className="file_upload">
          <i className="fas fa-image text-danger p-2" />
          <input
            type="file"
            name="file"
            id="file"
